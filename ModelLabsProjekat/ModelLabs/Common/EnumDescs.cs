...
namespace FTN.Common
{
	public class EnumDescs
	{
		...
		public EnumDescs()
		{
			...
			property2enumType.Add(ModelCode.BASICINTERVALSCHEDULE_VALUE1MULTIPL, typeof(UnitMultiplier));														
			property2enumType.Add(ModelCode.BASICINTERVALSCHEDULE_VALUE1UNIT, typeof(UnitSymbol));
			property2enumType.Add(ModelCode.BASICINTERVALSCHEDULE_VALUE2MULTIPL, typeof(UnitMultiplier));														
