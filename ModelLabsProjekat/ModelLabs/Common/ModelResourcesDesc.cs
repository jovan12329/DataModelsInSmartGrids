...
{	
	...
	public class ModelResourcesDesc
	{
		...
		{			
			...
			notSettablePropertyIds.Add(ModelCode.REGULATINGCONTROL_REGCONDEQS);
			notSettablePropertyIds.Add(ModelCode.REGULATINGCONTROL_REGSCHEDULERS);
			notSettablePropertyIds.Add(ModelCode.TERMINAL_REGCONTROLS);
            notSettablePropertyIds.Add(ModelCode.DAYTYPE_SEASONDAYSCHEDS);	
            notSettablePropertyIds.Add(ModelCode.SEASON_SEASONDAYSCHEDS);	 
		}
